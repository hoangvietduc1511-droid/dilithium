...
{
	iki_sensitize(dp, "xsim.dir/tb_dilithium_sign_top_behav/xsim.reloc");
}
...

{
	...
	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1311320, dp + 1484224, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1314536, dp + 1484448, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1311376, dp + 1484504, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1313544, dp + 1484896, 0, 7, 0, 7, 8, 1);

}

void simulate(char *dp)
{
		iki_schedule_processes_at_time_zero(dp, "xsim.dir/tb_dilithium_sign_top_behav/xsim.reloc");
	wrapper_func_0(dp);
...
int main(int argc, char **argv)
{
    ...
    iki_set_sv_type_file_path_name("xsim.dir/tb_dilithium_sign_top_behav/xsim.svtype");
    iki_set_crvs_dump_file_path_name("xsim.dir/tb_dilithium_sign_top_behav/xsim.crvsdump");
    void* design_handle = iki_create_design("xsim.dir/tb_dilithium_sign_top_behav/xsim.mem", (void *)relocate, (void *)sensitize, (void *)simulate, (void*)0, 0, isimBridge_getWdbWriter(), 0, argc, argv);
