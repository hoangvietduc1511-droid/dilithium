...
entity polyvecl_ntt is
  generic (
    L : natural := 4;   -- s? l??ng poly trong vector l
    N : natural := 256  -- b?c c?a poly
  );
  port (
    clk   : in  std_logic;
    reset : in  std_logic;
...
architecture rtl of polyvecl_ntt is
  component poly_ntt
  ...
  signal idx        : natural range 0 to L-1 := 0;
